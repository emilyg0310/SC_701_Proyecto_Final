...
namespace API.Wizard.Servicios
{
    ...
    {
        public List<Models.Provincia> GetAll()
        {
        ...
        public async Task<List<Models.Provincia>> GetAllAsync()
        {
            List<Models.Provincia> aux = new List<Models.Provincia>();
            using (var cl = new HttpClient())
            {
        ...
        public Models.Provincia GetById(int? id)
        {
        ...
        public bool Updated(int id, Models.Provincia Provincia)
        {
            try
            {
                using (var cl = new HttpClient())
        ...
        public bool Create(Models.Provincia Provincia)
        {
            try
            {
                using (var cl = new HttpClient())
